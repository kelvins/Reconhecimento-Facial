...
###################################################################################################################
#
# This script is used to perform face recognition using the Eigenface algorithm provided by the OpenCV library.
#
###################################################################################################################
...
eigenface.train(trainingImages, np.array(labels))
...
def recognize_face(path):
    ...
    global labels, trainingImages, eigenface
    ...
    subject, confidence = eigenface.predict( image )
